...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Dennis', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一個熱愛思考商業策略的理工人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://denniswang.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '商業知識,營運策略,專案管理,數位工具', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/dennisjyw/image/refs/heads/main/dennis_emoji.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一個熱愛思考商業策略的理工人,Hi，一個熱愛思考商業策略的理工人',
