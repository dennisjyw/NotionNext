...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Design × Industrial × Mechanical', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dimtech.tw', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'CAD,設計', // 网站关键词 英文逗号隔开
