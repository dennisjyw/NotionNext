...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一些常用的網站和工具', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://nav.denniswang.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '導航網站, 線上工具', // 网站关键词 英文逗号隔开
